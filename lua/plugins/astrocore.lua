...
return {
  ...
  opts = {
    ...
    features = {
      large_buf = { size = 1024 * 50, lines = 10000 }, -- set global limits for large files for disabling features like treesitter
    ...
    mappings = {
      ...
      n = {
        ...
        ["<leader>lF"] = { "<cmd>silent! EslintFixAll<cr>", desc = "Eslint fix" },
